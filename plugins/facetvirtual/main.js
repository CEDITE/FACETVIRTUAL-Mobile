var templates = [
    "root/externallib/text!root/plugins/facetvirtual/theme.css",
    "root/externallib/text!root/plugins/facetvirtual/login.html",
    "root/externallib/text!root/plugins/facetvirtual/program.html"
];
...
define(templates, function (theme, loginForm, program) {
    var plugin = {
        ...
        routes: [
            ["facetvirtual", "show_program", "showProgram"]
        ],

        showProgram: function() {
            var tpl = {};
            var html = MM.tpl.render(program, tpl);
            MM.panels.show('center', html, {title: MM.lang.s("facetvirtual")});
        }
    };
